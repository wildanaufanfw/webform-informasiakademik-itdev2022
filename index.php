...
<head>
  ...
  <title> Sistem Informasi Akademik UNEJ </title>
    ...
    <div class="main_container">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <center>
              &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span>
                  <font size="4.95" color="white" face="Helvetica Neue">WEBSITE AKADEMIK</font>
                </span></a>
            </center>
          </div>
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open">
                <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                  <img src="assets/images/foto.jpg" alt="">Wildan Aufan
                </a>
      ...
      <footer>
        <div class="pull-right">
          Copyright @ 2022 Aplikasi Akademik : Wildan Aufan
        </div>
        <div class="clearfix"></div>
      </footer>
      <!-- /footer content -->
